@ModelType List(Of purchased_order)
@Code
                                                ...
                                                @If Model IsNot Nothing Then
                                                    @For Each item In Model
                                                        @<tr>
                                                            ...
                                                            <td>@item.user_id</td>
                                                            <td><a href="http://localhost:53005/Manager/PurchaseOrderDetail/@item.id" class="btn btn-success"><i class="fa fa-info" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                    Next
